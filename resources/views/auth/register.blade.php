            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="is_buyer" class="col-md-4 col-form-label text-md-end">Зарегистрироваться как</label>

                            <div class="col-md-6">
                                <select name="is_buyer" class="form-control @error('is_buyer') is-invalid @enderror">
